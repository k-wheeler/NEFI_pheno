...
plotRun <- function(out.mat,forecastType,endDate){
  ...
  plotForecastOutput(siteName=siteName,URL=URL,forecastLength=0,out.mat=out.mat.lastYear,forecastType = forecastType,days=seq(1,lengthLastYear,1),xlim=c(0,550))
