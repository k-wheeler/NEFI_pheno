...
##'
##' @param j.model The JAGS model (in text not compiled)
...
##' @param nchain The number of chains (default=3)
##' @param data The data in list format
...
##' @import coda
##' @import parallel
runForecastIter_parallel <- function(j.model,variableNames,maxIter=10**9,baseNum=5000,iterSize =5000,ID="",effSize=5000,partialFile=FALSE,nchain=3,data){
