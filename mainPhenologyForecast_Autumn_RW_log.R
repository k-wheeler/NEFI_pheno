...
#for(i in iseq){
  ...
  outputFile <- paste(saveDirectory,siteName,"_",startDate,"_",endDate,"_RW_outBurn.RData",sep="")
  ...
  outputFile <- paste(saveDirectory,siteName,"_",startDate,"_",endDate,"_log_outBurn.RData",sep="")
  if(!file.exists(outputFile)){
